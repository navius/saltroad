...
import biz.navius.saltroad.constants.PrefConstants;
...
public class MainPreferences extends PreferenceActivity implements OnSharedPreferenceChangeListener, PrefConstants {
	...
	public void onSharedPreferenceChanged(SharedPreferences aPref, String aKey) {
		...
		if(aKey.equalsIgnoreCase("pref_dir_maps")){
			findPreference("pref_main_usermaps").setSummary("Maps from "+aPref.getString("pref_dir_maps", "/sdcard/saltroad/maps/"));
			findPreference(aKey).setSummary(aPref.getString("pref_dir_maps", "/sdcard/saltroad/maps/"));


			final File dir = new File(aPref.getString("pref_dir_maps", "/sdcard/saltroad/maps/").concat("/").replace("//", "/"));
			if(!dir.exists()){
			...
			findPreference("pref_dir_main").setSummary(aPref.getString("pref_dir_main", "/sdcard/saltroad/"));
			findPreference("pref_dir_import").setSummary(aPref.getString("pref_dir_import", "/sdcard/saltroad/import/"));
			findPreference("pref_dir_export").setSummary(aPref.getString("pref_dir_export", "/sdcard/saltroad/export/"));
		}
