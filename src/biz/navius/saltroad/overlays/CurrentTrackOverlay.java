...
import biz.navius.saltroad.trackwriter.IRemoteService;
import biz.navius.saltroad.trackwriter.ITrackWriterCallback;
	...
	private class TrackThread extends Thread {
		...
		public void run() {
			...
			if(folder.canRead()){
				...
				try {
					db = new biz.navius.saltroad.trackwriter.DatabaseHelper(mContext, folder.getAbsolutePath() + "/writedtrack.db").getReadableDatabase();
				} catch (Exception e) {
					db = null;
				}
