...
public class CopyMapFileToSDCardHandler extends Handler
{
	private MainMapActivity parentActivity = null; 
	
	public CopyMapFileToSDCardHandler(MainMapActivity inParentActivity)
	{
	...
	{
		parentActivity.copyMapToSDCardSuccessPreference(success);
	}
}
